...
// Define the Pizza struct with available pizza option and their prices
#[derive(Debug, Clone)]
struct Pizza {
    name: String,
    price: f64,
...
impl Order {
    ...
    fn total_price(&self, piza_menu: &HashMap<String, Pizza>) -> Option<f64> {
        match piza_menu.get(&self.pizza) {
